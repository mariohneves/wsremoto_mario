...
public class DesafioWhile {
	...
	public static void main(String[] args) {
		// 
		/*
		 * Sua aplicação ira pedir: Ano, mês e dia, em variavéis inteiras separadamente.
		 * 
		 ...
		 * 
		 * 
		 * No final, exibe a data dia/mês/ano
		 */
		...
		while (mes>12 && mes==0 ==false) {
			mes = Byte.parseByte(JOptionPane.showInputDialog("Mês deve estar entre 1 e 12"));
		}
		if (mes==2) {
			while (dia<1 || dia>29 ) {
				dia = Byte.parseByte(JOptionPane.showInputDialog("Fevereiro só tem 29 dias"));
			}
