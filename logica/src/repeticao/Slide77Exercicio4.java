...
public class Slide77Exercicio4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Média de Idades: " + (idadetotal / total));
		System.out.println("A pessoa mais experiente é " + nomeExperiente + " com a idade: " + idadeExperiente);
		System.out.println("A pessoa mais jovem é " + nomeJovem + " com a idade: " + idadeJovem);
