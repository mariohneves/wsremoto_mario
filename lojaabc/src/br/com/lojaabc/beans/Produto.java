...
public class Produto {
	...
	public String verificarEstoque() {
		if (qtde < 5) {
			...
			return "Estoque normal com" + qtde + "unidades";
		}
	}
	...
	public void setProduto(int id, String descricao, float valorCompra, float valorVenda, int qtde,
