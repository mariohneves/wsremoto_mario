...
public class Curso {
	 ...
	 * - Crie um getPromocao(float porcentagem) -> vai retornar o valor do curso com a % de desconto recebida
	 * - Crie um metodo de ajustarValor (float porcentagem) -> vai alterar o valor do curso com a % de desconto recebida
	 */
	...
	public float ajustarValor(float porcentagem) {
			return valor + valor * (porcentagem/100);	
